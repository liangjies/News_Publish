<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="news_User_Add.aspx.cs" Inherits="WebApplication1.admin.news_User_Add" %>
        ...
        <div class="layui-side layui-bg-black">
            <div class="layui-side-scroll">
                ...
                <ul class="layui-nav layui-nav-tree" lay-filter="test">
                    ...
                    <li class="layui-nav-item">
                        <a class="layui-this" href="news_User_Add.aspx">添加用户</a>
                    </li>
                </ul>
            </div>
        </div>
