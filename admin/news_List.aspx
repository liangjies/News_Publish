<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="news_List.aspx.cs" Inherits="WebApplication1.admin.news_List" %>
  ...
  <div class="layui-side layui-bg-black">
    <div class="layui-side-scroll">
      ...
      <ul class="layui-nav layui-nav-tree"  lay-filter="test">
        <li class="layui-nav-item">
          <a class="layui-this" href="news_List.aspx">文章列表</a>
        </li>
    ...
    layui.use('table', function () {
        ...
        table.render({
            ...
            , cols: [[ //表头
                ...
                , { field: 'label', title: '类型', width: 80 }
                , { field: 'user', title: '作者', width: 80 }
