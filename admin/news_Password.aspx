<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="news_Password.aspx.cs" Inherits="WebApplication1.admin.news_Password" %>
            ...
            <div class="layui-side-scroll">
                ...
                <ul class="layui-nav layui-nav-tree" lay-filter="test">
                    <li class="layui-nav-item layui-nav-itemed">
                        <a class="" href="news_User.aspx">用户列表</a>
                    </li>
                    <li class="layui-nav-item">
                    ...
                    <form id="form1" runat="server">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <asp:TextBox ID="TextBox1" runat="server" CssClass="layui-input" ReadOnly="True"></asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <asp:TextBox ID="TextBox2" runat="server" type="password" CssClass="layui-input"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="RequiredFieldValidator" ControlToValidate="TextBox2" Text="所填写内容不能为空！" ForeColor="Red"></asp:RequiredFieldValidator>
                            </div>
                        </div>
